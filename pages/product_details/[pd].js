            ...
            <div className="container px-5 py-24 mx-auto">
                <div className="w-full lg:w-4/5 mx-auto flex flex-wrap justify-center">
                    <div className="w-full md:w-1/2  lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                        ...
                        <div className="flex text-gray-500 dark:text-gray-400 border-t border-gray-300 dark:border-gray-700 py-2">
                            <span className="">FlashSale</span>
                            <span className="ml-auto">{flashSale ? 'Yes' : 'No'}</span>
                        </div>
                        <div className="flex text-gray-500 dark:text-gray-400 border-t border-gray-300 dark:border-gray-700 py-2">
                            <span className="">Quantity</span>
                            <span className="ml-auto">{quantity}</span>
                        </div>
                        <div className="flex text-gray-500 dark:text-gray-400 border-t border-b mb-6 border-gray-300 dark:border-gray-700 py-2">
                        ...
                        <div className="flex">
                            ...
                            <button onClick={() => setFav(!fav)} className={`rounded-full w-10 h-10 p-0 border-0 inline-flex items-center justify-center text-gray-500 ml-4 ${fav ? 'bg-[#10b98123]' : 'bg-gray-200 dark:bg-gray-700'}`}>
